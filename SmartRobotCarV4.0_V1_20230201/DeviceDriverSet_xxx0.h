...
public:
  ...
  void DeviceDriverSet_ULTRASONIC_GetRight(uint16_t *ULTRASONIC_Get /*out*/);

private:
#define TRIG_PIN 52    // Arduino pin tied to trigger pin on the ultrasonic sensor.
...
#define LIGHT_PINRR 35
#define LIGHT_PINR 47
#define LIGHT_PINM 33
#define LIGHT_PINL 45
#define LIGHT_PINLL 31
#define PEWPEW_PIN 41
};
/*Servo*/
#include <Servo.h>
...
private:
#define PIN_Servo_z 0
#define PIN_Servo_y 1
};
/*IRrecv*/
#include "IRremote.h"
